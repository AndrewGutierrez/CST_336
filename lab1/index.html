...
<!-- All styles and javascript go inside the head -->
    <head>
        <meta charset="utf-8"/>
        <title>Andrew Gutierrez: Personal Website</title>
...
<!-- closing head -->
    ...
    <body>
        ...
        <main>
            <figure id="me">
                <img src="img/me.png" alt="Picture of Andrew Gutierrez"/>
                <br />
            </figure>
            <div id="welcomeText">
                Hello! <br />
                ...
                <p>
                    I am a Software Engineer and have been recently hirred at the Acme Corporation.
                </p>
                <p>
        ...
        <footer>
            ...
            <br />
            <img src="img/CSUMB_logo.jpg" alt="Picture of CSUMB logo"/>
        </footer>
        <!-- closing footer -->
